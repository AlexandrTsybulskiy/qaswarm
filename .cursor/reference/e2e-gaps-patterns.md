...
| **Duplicate qaswarm_tc markers** | Fix before re-scan; `e2e_scan.py` exit 2 | «Unblocked scan by deduping markers on …» | Single marker per tc-id |
...
5. `<playwright.root>/.cursor/reference/` (e.g. `virtuoso-scroll.md`)
